    ...
    <div class="fixed bg-white pb-5 w-full flex flex-col items-center">
      ...
      <div class="w-92.5 h-10 relative mt-3.75">
        <div class="px-4 flex gap-2.5 overflow-x-auto">
          ...
          <button class="shrink-0 px-7.5 bg-slate-500/20 text-slate-500 font-bold text-2l py-2.5">作り置き</button>
          <button class="shrink-0 px-7.5 bg-slate-500/20 text-slate-500 font-bold text-2l py-2.5">ご飯</button>
          <button class="shrink-0 px-7.5 bg-slate-500/20 text-slate-500 font-bold text-2l py-2.5">お弁当のおかず</button>
          <button class="shrink-0 px-7.5 bg-slate-500/20 text-slate-500 font-bold text-2l py-2.5">味付け</button>
          <button class="shrink-0 px-7.5 bg-slate-500/20 text-slate-500 font-bold text-2l py-2.5">朝</button>
          <button class="shrink-0 px-7.5 bg-slate-500/20 text-slate-500 font-bold text-2l py-2.5">健康飯・ダイエット飯</button>
        </div>
      </div>
    </div>
